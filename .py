...
try:
    # PASTIKAN PATH INI BENAR SESUAI LOKASI FILE PCA9685.py ANDA
...
CONFIG = {
    ...
    "servo": {
        ...
        "tilt_center_pulse": 1500, # <-- NILAI DIUBAH DARI 1000 KE 1500
        "pan_min_pulse": 750, "pan_max_pulse": 2250, 
        "tilt_min_pulse": 800, "tilt_max_pulse": 2200,
        # COBA UBAH NILAI INI DARI -1 JADI 1 (ATAU SEBALIKNYA) JIKA ARAH TERBALIK
        "pan_inversion": -1, 
        # COBA UBAH NILAI INI DARI 1 JADI -1 (ATAU SEBALIKNYA) JIKA ARAH TERBALIK
        "tilt_inversion": 1, 
        "manual_step_pulse": 20
    },
...
while True:
    ...
    if key == ord('s') and not tracking:
        ...
        if key == 81: current_pan -= step # Panah Kiri
        elif key == 83: current_pan += step # Panah Kanan
        elif key == 82: current_tilt += step # Panah Atas
        elif key == 84: current_tilt -= step # Panah Bawah
        servo_controller.update(current_pan, current_tilt)
