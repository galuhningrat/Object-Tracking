...
CONFIG = {
    ...
    "servo": {
        ...
        "pan_center_pulse": 1500, "tilt_center_pulse": 1000,
        "pan_min_pulse": 750, "pan_max_pulse": 2250,
        "tilt_min_pulse": 800, "tilt_max_pulse": 2200,
        "pan_inversion": -1, "tilt_inversion": 1,
        "manual_step_pulse": 20  #Konrol gerakan servo 
    },
...
while True:
    ...
    key = cv2.waitKey(1) # <-- PERUBAHAN: Hapus & 0xFF
    ...
    # --- LOGIKA KONTROL SERVO MANUAL (TAMBAHAN) ---
        ...
        if key == 81: current_pan -= step # KIRI
        elif key == 83: current_pan += step # KANAN
        elif key == 82: current_tilt += step # ATAS
        elif key == 84: current_tilt -= step # BAWAH
        servo_controller.update(current_pan, current_tilt)
